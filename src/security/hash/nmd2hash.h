...
/**
\file nmd2hash.h NMd2Hash class definition
\example hashapp.cpp 
\include hashapp.h
...
/**
\brief NMd2Hash class is the class definition for md2 hash calculation 
algorithm.
\see NAbstractHash for inherited methods
*/
class DllDeclSpec NMd2Hash: public NAbstractHash {
	public:
		/**
		\brief Constructs a NMd2Hash object
		*/
		NMd2Hash(void);
		
		/**
		\brief Destroys a NMd2Hash object
		*/
		~NMd2Hash(void);
