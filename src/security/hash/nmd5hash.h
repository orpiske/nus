...
/**
\file nmd5hash.h NMd5Hash class definition
\example hashapp.cpp 
\include hashapp.h
...
/**
\brief NMd5Hash class is the class definition for md5 hash calculation 
algorithm.
\see NAbstractHash for inherited methods
*/
class DllDeclSpec NMd5Hash: public NAbstractHash {
	public:
	
		/**
		\brief Constructs a NMd5Hash object
		*/
		NMd5Hash(void);
		
		/**
		\brief Destroys a NMd5Hash object
		*/
		~NMd5Hash(void);
